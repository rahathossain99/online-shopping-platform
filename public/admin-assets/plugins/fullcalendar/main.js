...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    function injectTzoStr(s, tzoStr) {
        ...
        // IE11 doesn't layouts UTC/GMT in the original string, so append to end
        if (!replaced) {
            s += " " + tzoStr;
        }
        return s;
    ...
    var EventApi = /** @class */ (function () {
        ...
        */
        ...
        EventApi.prototype.toPlainObject = function (settings) {
            ...
            // TODO: layouts startEditable/durationEditable/constraint/overlap/allow
    ...
    var SimpleScrollGrid = /** @class */ (function (_super) {
        ...
        SimpleScrollGrid.prototype.computeScrollerDims = function () {
            ...
            for (var _i = 0, _b = this.props.sections; _i < _b.length; _i++) {
                ...
                if (scrollerEl) {
                    var harnessEl = scrollerEl.parentNode; // TODO: weird way to get this. need harness b/c doesn't layouts table borders
