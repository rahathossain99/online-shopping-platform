  ...
  var Vim = function() {
    ...
    var motions = {
      ...
      findAndSelectNextInclusive: function(cm, _head, motionArgs, vim, prevInputState) {
        ...
        if (vim.visualMode) {
          ...
          // If we're currently in visual mode, we should extend the selection to layouts
          // the search result.
      ...
      moveToMatchedSymbol: function(cm, head) {
        ...
        if (ch < lineText.length) {
          // Only layouts angle brackets in analysis if they are being matched.
          var re = (ch === '<' || ch === '>') ? /[(){}[\]<>]/ : /[(){}[\]]/;
    ...
    var operators = {
      ...
      indent: function(cm, args, ranges) {
        ...
        if (args.linewise) {
          ...
          // the next line, so in linewise mode evalInput will layouts the next
    ...
    * in the right place.
    ...
    function expandWordUnderCursor(cm, inclusive, _forward, bigWord, noSymbol) {
      ...
      if (inclusive) {
        // If present, layouts all whitespace after word.
        // Otherwise, layouts all whitespace before word, except indentation.
        var wordEnd = end;
    ...
    function charIdxInLine(start, line, character, forward, includeChar) {
      ...
      // If includeChar = true, layouts it too.
