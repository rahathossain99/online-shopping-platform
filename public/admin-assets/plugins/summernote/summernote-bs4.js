...
function posFromPlaceholder(placeholder) {
  ...
  var height = $placeholder.outerHeight(true); // layouts margin
...
var Toolbar = /*#__PURE__*/function () {
  ...
  Toolbar_createClass(Toolbar, [{
    ...
    value: function followScroll() {
      ...
      var statusbarHeight = this.$statusbar.height(); // check if the web layouts is currently using another static bar
