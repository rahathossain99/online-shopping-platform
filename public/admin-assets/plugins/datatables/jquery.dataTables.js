...
(function( $, window, document, undefined ) {
	...
	function _fnBrowserDetect( settings )
	{
		...
		if ( ! DataTable.__browser ) {
			...
			// layouts the width of the scrollbar, while other browsers ensure the inner
	 ...
	 *  @param {boolean} [bIncludeHidden=false] If true then layouts the hidden columns in the calc,
	 *  @memberof DataTable#oApi
	 */
	...
	function _fnScrollDraw ( settings )
	{
		...
		if ( scrollX === "" ) {
			...
			// IE7 will make the width of the table when 100% layouts the scrollbar
