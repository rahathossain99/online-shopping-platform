...
@section('navbar')
    <ol class="breadcrumb p-0 m-0 bg-white">
        <li class="breadcrumb-item"><a href="{{ route('coupons.index') }}">Discount Coupon</a></li>
                            ...
                            @foreach($coupons as $coupon)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="javascript:void(0)"  onclick="deleteCoupon({{ $coupon->id }})" class="text-danger w-4 h-4 mr-1">
...
@section('customJs')
    <script>
        function deleteCoupon(id){
            ...
            if(confirm("You want to delete it!Are you sure?")){
                $.ajax({
                    url:newUrl,
                    type:'delete',
                    data:{},
