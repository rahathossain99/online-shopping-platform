    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="container-fluid">
                <form action="" method="put" id="couponsForm" name="couponsForm">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <textarea type="text" name="description" id="description" value="{{ $coupon->description }}" class="form-control" placeholder="Description"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="max_uses">Max Uses</label>
                                        <input type="text" name="max_uses" id="max_uses" value="{{ $coupon->max_uses }}" class="form-control" placeholder="Max Uses">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="max_uses_user" id="max_uses_user" value="{{ $coupon->max_uses_user }}" class="form-control" placeholder="Max Uses User">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="discount_amount" id="discount_amount" value="{{ $coupon->discount_amount }}" class="form-control" placeholder="Discount Amount">
                                        <p></p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="min_amount" id="min_amount" value="{{ $coupon->min_amount }}" class="form-control" placeholder="Min Amount">
                                        <p></p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="datetime-local" name="starts_at" id="starts_at" value="{{ $coupon->starts_at }}" class="form-control" placeholder="Starts At">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="expires_at">Expires At</label>
                                        <input type="datetime-local" name="expires_at" id="expires_at" value="{{ $coupon->expires_at }}" class="form-control" placeholder="Expires At">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
